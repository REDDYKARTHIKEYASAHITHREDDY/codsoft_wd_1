    ...
    return (
        <div className="App">
            ...
            <Section id="references" title="References">
                <ul>
                    <li>Hari Kiran Vege - <a href="mailto:hari.vege@kluniversity.in">hari.vege@kluniversity.in</a></li>
                    <li>Santhisri T - <a href="mailto:santhisri@kluniversity.in">santhisri@kluniversity.in</a></li>
                </ul>
            </Section>
        </div>
    );
